...
class WebPageControllerTest extends TestCase
{
    ...
    public function can_get_list_posts_with_constraints_by_web_router()
    {
        ...
        $response = $this->call('GET', 'post-management/pages?constraints={"title":"' . $constraint_title . '"}');
    ...
    public function can_get_list_posts_with_search_by_web_router()
    {
        ...
        $response = $this->call('GET', 'post-management/pages?search=' . $search);
    ...
    public function can_get_list_posts_with_order_by_by_web_router()
    {
        ...
        $response = $this->call('GET', 'post-management/pages?order_by={"title":"DESC"}');
